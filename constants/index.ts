...
export const POI_CATEGORIES: POICategoryMeta[] = [
  ...
  { key: "groceries", label: "Groceries", group: "food", color: "#22C55E", iconName: "ShoppingCart" },
  ...
  { key: "coffee", label: "Coffee", group: "food", color: "#A16207", iconName: "Coffee" },
  { key: "restaurant", label: "Restaurant", group: "food", color: "#F59E0B", iconName: "Utensils" },
  { key: "bar_pub", label: "Bar / Pub", group: "food", color: "#D97706", iconName: "UtensilsCrossed" },
  ...
  { key: "hospital_er", label: "Hospital / ER", group: "help", color: "#DC2626", iconName: "Hospital" },
  { key: "defibrillator", label: "Defibrillator", group: "help", color: "#EF4444", iconName: "HeartPulse" },
  { key: "emergency_phone", label: "Emergency Phone", group: "help", color: "#7C2D12", iconName: "Phone" },
  { key: "ambulance_station", label: "Ambulance", group: "help", color: "#B91C1C", iconName: "Ambulance" },
  { key: "bike_shop", label: "Bike Shop", group: "repair", color: "#2563EB", iconName: "Bike" },
  { key: "repair_station", label: "Repair Station", group: "repair", color: "#0F766E", iconName: "Wrench" },
  { key: "pump_air", label: "Pump / Air", group: "repair", color: "#0891B2", iconName: "CircleDot" },
  { key: "train_station", label: "Train Station", group: "escape", color: "#475569", iconName: "TrainFront" },
